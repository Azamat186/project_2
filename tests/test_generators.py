...
@pytest.mark.parametrize(
    ...
    ids=["single_description", "empty_description", "many_descriptions", "no_transactions"],
)
...
@pytest.mark.parametrize(
    ...
    ids=["simple_case", "empty_list", "no_match", "partial_match", "all_match", "missing_key"],
)
...
@pytest.mark.parametrize(
    ...
    ids=["small_range", "medium_range", "maximal_range"],
)
